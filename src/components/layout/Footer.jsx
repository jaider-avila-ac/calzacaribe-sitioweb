...
const CAT_LINKS = [
  { label: 'Mujer',      href: 'https://pruebacalzacaribe.netlify.app/catalogo?categoria=1' },
  { label: 'Hombre',     href: 'https://pruebacalzacaribe.netlify.app/catalogo?categoria=2' },
  { label: 'Niños',      href: 'https://pruebacalzacaribe.netlify.app/catalogo?categoria=3' },
  { label: 'Ropa',       href: 'https://pruebacalzacaribe.netlify.app/catalogo?categoria=4' },
  { label: 'Sandalias',  href: 'https://pruebacalzacaribe.netlify.app/catalogo?categoria=5' },
  { label: 'Ofertas',    href: 'https://pruebacalzacaribe.netlify.app/catalogo?descuento=true' },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              {[
                { Icon: IconInstagram, href: 'https://www.instagram.com/calzacaribe_baq/', label: 'Instagram' },
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-xl flex items-center justify-center hover:bg-accent hover:text-white transition-all"
                >
                  <Icon size={17} />
                </a>
              ))}
