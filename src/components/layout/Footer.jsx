          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              {[
                ...
                { Icon: IconFacebook, href: 'https://www.facebook.com/share/19awX8nE69/', label: 'Facebook' },
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 flex items-center justify-center text-white hover:bg-white/10 transition-all"
                >
                  <Icon size={17} />
                </a>
              ))}
