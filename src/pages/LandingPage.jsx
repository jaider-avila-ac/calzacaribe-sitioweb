...
function IconInstagram({ size = 17, className }) {
  return (
    ...
    <div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <IconInstagram size={40} className="text-white mx-auto mb-5" />
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-3">Síguenos en Instagram</h2>
            <p className="text-white/90 text-sm mb-8 max-w-md mx-auto">
              Descubre nuestras últimas novedades, promociones y el detrás de cámaras de Calzacaribe.
            </p>
            <a
              href="https://www.instagram.com/calzacaribe_baq/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white hover:bg-black text-black hover:text-white font-black text-sm px-7 py-3.5 transition-colors"
            >
